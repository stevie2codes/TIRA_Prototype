...
export const savedReports = [
  {
    id: 'sr-1',
    title: 'Daily Inspection Queue',
    type: 'Standard',
    category: 'Permitting & Licensing',
    description: 'All requested inspections with routing, priority, and inspector assignment details.',
  ...
  },
  {
    ...
    type: 'Standard',
    category: 'Permitting & Licensing',
    description: 'Aggregated inspection results by type, outcome, and inspector for the current month.',
    schedule: '1st of each month',
    lastRun: 'Mar 1, 2026',
    rows: 312,
    owner: 'Tyler Technologies',
    access: 'Report Builders + Admins',
  },
  {
    id: 'sr-3',
    title: 'Building Permits by Month — Downtown Only',
    type: 'Custom Variant',
    category: 'Permitting & Licensing',
    description: 'Modified version of Building Permits by Month, filtered to Downtown district.',
    schedule: null,
    lastRun: 'Mar 18, 2026',
    rows: 892,
    owner: 'Stephen Webb',
    access: 'My Department',
  },
  {
    id: 'sr-4',
    title: 'Juvenile Aging Out — Monthly',
    type: 'Standard',
    category: 'Justice & Public Safety',
    description: 'Subjects turning 18 in a given month with case details and facility assignment.',
    schedule: '1st of each month',
    lastRun: 'Mar 1, 2026',
    rows: 47,
    owner: 'Tyler Technologies',
  ...
  {
    id: 'sr-5',
    title: 'Weekly Ward Failures',
    type: 'Standard',
    category: 'Code Enforcement',
    description: 'Failed inspections by ward with violation details, re-inspection scheduling.',
  ...
  {
    id: 'sr-6',
    title: 'Budget vs. Actuals — FY2025',
    type: 'Ad-hoc Saved',
    category: 'Finance',
    description: 'Department budget comparison with variance and utilization tracking.',
    schedule: null,
    lastRun: 'Mar 19, 2026',
    rows: 10,
    owner: 'Stephen Webb',
  ...
  {
    id: 'sr-7',
    title: 'Account Billing Method Breakdown',
    type: 'Standard',
    category: 'Utilities & Billing',
    description: 'Accounts on email vs. printed bills, by service area and account type.',
  ...
  {
    id: 'sr-8',
    title: 'Drug-Related Charges Analysis',
    type: 'Ad-hoc Saved',
    category: 'Justice & Public Safety',
    description: 'Cases with drug-related charges, broken down by dismissed vs. active status.',
    schedule: null,
    lastRun: 'Mar 15, 2026',
    rows: 234,
    owner: 'Stephen Webb',
